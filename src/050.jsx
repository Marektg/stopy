...
function Stop050() {
    ...
    return (
        <Main>
            <Paragraf>Przygotowujesz stop ZnAl6Mg05</Paragraf>
            <Formik
                initialValues={{
                    zawartosc: '',
                ...
                onSubmit={(values) => {
                    ...
                    alert(`Dodaj ${addAl.toFixed(0)} kg aluminium. Dodaj ${addMg.toFixed(1)} kg magnezu. Dolej do ${masaKoncowa.toFixed(0)} kg w piecu`)
